...
data = dict(
    train=dict(
        img_prefix='/home/wutongg/545project/data_copy/train/images',
        classes=classes,
        ann_file='/home/wutongg/545project/data_copy/train/top50cat_train_filter_fixed.json'),
    val=dict(
        img_prefix='/home/wutongg/545project/data_copy/val/images',
        classes=classes,
        ann_file='//home/wutongg/545project/data_copy/val/top50cat_val_filter_fixed.json'),
    test=dict(
        img_prefix='/home/wutongg/545project/data_copy/val/images',
        classes=classes,
        ann_file='/home/wutongg/545project/data_copy/val/top50cat_val_filter_fixed.json'))
